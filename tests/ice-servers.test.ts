...
import { IceServerService } from '../src/streaming/ice-servers.service.js';

describe('IceServerService & Coturn NAT Traversal (LIVE-04, T-04-02)', () => {
  it('returns default STUN configuration when TURN is not configured', () => {
    const service = new IceServerService({
  ...
  it('generates ephemeral RFC 5766 HMAC-SHA1 credentials when TURN is enabled', () => {
    ...
    const servers = service.getIceServers('viewer_device_01');
